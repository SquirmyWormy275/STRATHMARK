...
class TestProfileCompetitorExtended:
    ...
    def test_activity_level_moderate(self):
        ...
        today = date.today()
        history = [
            HistoricalResult("SB", 30.0, "S01", 300, 5, today - timedelta(days=100)),
            HistoricalResult("SB", 31.0, "S01", 300, 5, today - timedelta(days=200)),
        ]
    ...
    def test_division_passed_through(self):
        record = CompetitorRecord(name="Alice", history=[], division="Open")
        profile = profile_competitor(record)
