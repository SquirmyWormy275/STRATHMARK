    ...
    def test_multiple_events(self):
        ...
        events = [
            ...
            },
            {
                ...
                'quality': 5,
                'competitors': [
                    CompetitorRecord(name="Alice", history=_history(event_code="UH", base_time=30.0)),
...
class TestCalculatorEdgeCases:
    ...
    def test_to_simulation_dict(self):
        ...
        mr = MarkResult(
            name="Alice", mark=10, predicted_time=30.0,
            method_used="baseline", confidence="HIGH",
            explanation="test", std_dev=3.0,
        )
...
class TestSelectHalfLife:
    ...
    def test_active(self):
        from strathmark.decay import select_half_life, HALF_LIFE_ACTIVE_DAYS
        assert select_half_life("active") == HALF_LIFE_ACTIVE_DAYS

    def test_moderate(self):
        from strathmark.decay import select_half_life, HALF_LIFE_MODERATE_DAYS
        assert select_half_life("moderate") == HALF_LIFE_MODERATE_DAYS

    def test_inactive(self):
        from strathmark.decay import select_half_life, HALF_LIFE_INACTIVE_DAYS
