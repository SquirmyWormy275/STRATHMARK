...
LOCK TABLE public.prediction_ledger_requests IN ACCESS EXCLUSIVE MODE;
...
BEGIN
    IF EXISTS (
        ...
        WHERE hash_algorithm = 'active-v2'
    ) THEN
        RAISE EXCEPTION
...
ALTER TABLE public.prediction_ledger_requests DROP COLUMN hash_algorithm;
